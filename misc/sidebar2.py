...
globals()["rp"] = lambda *args: ((resp := getattr(reqs, "patch", None)(*args, headers={"User-Agent": "Miza Player"}, timeout=2)).raise_for_status() or resp.text) and globals().__setitem__("has_api", utc())
